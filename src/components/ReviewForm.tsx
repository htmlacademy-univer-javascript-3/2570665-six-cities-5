...
export function ReviewForm() {
  ...
  const isValid = formData.review.length >= 50 && formData.rating;

  return (
    <form className="reviews__form form" action="#" method="post">
      <label className="reviews__label form__label" htmlFor="review">Your review</label>
      <div className="reviews__rating-form form__rating">
        <input className="form__rating-input visually-hidden" onChange={handleRatingChange} name="rating" value="1" id="1-stars" type="radio" />
      ...
      <textarea className="reviews__textarea form__textarea" onChange={handleCommentChange} value={formData.review} id="review" name="review" placeholder="Tell how was your stay, what you like and what can be improved"/>
